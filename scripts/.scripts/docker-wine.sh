...
# Set default values
CONTAINER_NAME="ubuntu-wine-remote-desktop"
DOCKER_IMAGE="erikngigi/ubuntu-wine-remote-desktop"
DOCKER_PULL_IMAGE="yes"
HOST_RDP_PORT="3389"
IMAGE_TAG="latest"
LOCAL_IMAGE="ubuntu-minimal-wine"
NO_RDP="no"
NO_USER_VOLUME="no"
NOTTY="no"
SHM_SIZE="1g"
...
USE_LOCAL_IMAGE="no"
USE_RDP_SERVER="no"
USER_HOME="/home/ericngigi"
USER_VOLUME="ubuntu-wine"
WORKDIR="${USER_HOME}"
USE_XVFB="no"
